! function(t) {
    ...
    1: function(t, e, i) {
        ...
        o.VantaBase = class {
            constructor(t = {}) {
                ...
                for (r = 0; r < this.el.children.length; r++) e = this.el.children[r], "static" === getComputedStyle(e).position && (e.style.position = "relative"), "auto" === getComputedStyle(e).zIndex && (e.style.zIndex = 1);
    ...
    10: function(t, e, i) {
        ...
        class n extends s.b {
            ...
            genPoint(t, e, i) {
                ...
                return this.cont.add(s), s.ox = t, s.oy = e, s.oz = i, s.position.set(t, e, i), s.r = Object(o.g)(-1, 2), this.points.push(s)
            }
            onInit() {
 ...
 // CAMERA LENS // 
               this.camera = new THREE.PerspectiveCamera(10, this.width / this.height, .01, 1e4), this.camera.position.set(50, 100, 150), this.scene.add(this.camera);
            ...
            onUpdate() {
                ...
                const e = this.camera;
                Math.abs(e.tx - e.position.x) > .05 && (t = e.tx - e.position.x, e.position.x += .02 * t), Math.abs(e.ty - e.position.y) > .01 && (t = e.ty - e.position.y, e.position.y += .02 * t), e.lookAt(new THREE.Vector3(0, 0, 0));
                let i = 0,
                    s = 0,
                    o = 0;
